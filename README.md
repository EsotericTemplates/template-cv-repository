# Template CV Repository

<sup>By [Esoteric Enderman](https://enderman.dev), licensed under [CC BY-SA-4.0](./LICENSE), generated from [Template CV Repository](https://github.com/EsotericTemplates/template-cv-repository) [1.0.0](https://github.com/EsotericTemplates/template-cv-repository/tree/1.0.0)</sup>

[![Repository Size](https://img.shields.io/github/repo-size/EsotericTemplates/template-cv-repository)](https://github.com/EsotericTemplates/template-cv-repository)

This repository serves as a template for generating new GitHub repositories for CVs.
...
- [ ] Update the [repository name](#template-cv-repository) in this file.
- [ ] Update the [repository description](#template-cv-repository) in this file.
- [ ] Update the [repository author](#template-cv-repository) in this file.
- [ ] Update the [link(s)](#template-cv-repository) of the badges.
